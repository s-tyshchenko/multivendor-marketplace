...
@if ($subscription)
<div id="create-custom-subscription-modal" class="modal fade custom-modal" tabindex="-1"
     aria-labelledby="create-custom-subscription-modal" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h4>{{ __('plugins/marketplace::store.create_custom_order') }}</h4>
            ...
            <div class="modal-body">
                ...
                {!! Form::open(['route' => 'public.cart.add-to-cart', 'method' => 'POST']) !!}
